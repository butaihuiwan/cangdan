...
class PATH:
    ...
    config_tmp_path = common_value.PATH
...
class BeautifulReport(ReportTestResult, PATH):
    ...
    # img_path = 'img\\' if os.name == 'nt' else 'img/'
    ...
    def output_report(self):
        ...
        override_path = os.path.abspath(self.log_path) + "\\" if \
            "\\" in os.path.abspath(self.log_path) else \
    ...
    def img2base(img_path: str, file_name: str) -> str:
        ...
        # TODO
        # img_path = r'C:\Users\TP\PycharmProjects\cangdan-test\suit\img' + '\\'
